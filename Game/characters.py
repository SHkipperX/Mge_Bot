...
from Game.stats import Damage, Accuracy, Health, Splash, CurDamage
from Game.constants import TARGET_HEAD, TARGET_BODY, SNIPER_STATS, SNIPER_HEAD_ACCURACY, SOLDIER_STATS, DEMOMAN_STATS
